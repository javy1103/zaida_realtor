                ...
                <header id="header" class="clearfix">
                    ...
                    <div id="header-top" class="clearfix">
                        ...
                        if(!empty($header_email)){
                            ?>
                            <h2 id="contact-email">
                                <a href="<?php echo home_url(); ?>"><?php echo antispambot($header_email); ?></a>
                                <span class="notranslate" id="speak-spanish" style="font-size: 14px; font-style: italic">&nbsp;&nbsp;Hablo Español</span>
                            </h2>
                            <?php
                        }
                        ?>
                    ...
                    <span class="tagline-slogan"> <?php echo get_bloginfo( 'description' ); ?></span>
