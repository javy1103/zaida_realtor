...
<div class="as-form-wrap">
    ...
    if ( in_array ( 'min-max-area', $theme_search_fields ) ) {
        ...
        ?>
        <div class="option-bar small">
            <label for="min-area"><?php _e('Living Area Min', 'framework'); ?> <span><?php if($area_unit){ echo "($area_unit)"; } ?></span></label>
        ...
        <div class="option-bar small">
            <label for="max-area"><?php _e('Living Area Max', 'framework'); ?> <span><?php if($area_unit){ echo "($area_unit)"; } ?></span></label>
    ...
    <div class="option-bar small">
            <label for="year-built"><?php _e('Min Year Built', 'framework'); ?></label>
            <input type="text" name="year-built" pattern="[0-9]+" value="<?php echo isset($_GET['year_built'])?$_GET['year_built']:''; ?>" placeholder="<?php _e('Min Year Built', 'framework'); ?>" title="<?php _e('Please only provide digits!','framework'); ?>" />
        </div>
