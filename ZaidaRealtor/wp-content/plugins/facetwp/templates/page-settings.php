...
<div class="wrap">
    ...
    <div class="facetwp-content facetwp-content-welcome about-wrap">
        ...
        <div class="welcome-box-wrap">
            <div class="welcome-box">
                <h2>Facets</h2>
                <p>A facet is an interactive element used to filter, or "drill-down", lists of content.</p>
                <a class="button" href="https://facetwp.com/documentation/facet-configuration/" target="_blank">Learn more</a>
            </div>
            <div class="welcome-box">
                <h2>Templates</h2>
                <p>A template is responsible for fetching and displaying posts. Facets require a template, because facet choices are generated based on the template's matching posts.</p>
    ...
    <div class="facetwp-content facetwp-content-facets">
        <div class="facetwp-action-buttons">
            ...
            <a class="button add-facet"><?php _e( 'Add New', 'fwp' ); ?></a>
            <div class="clear"></div>
        </div>
    ...
    <div class="facetwp-content facetwp-content-templates">
        <div class="facetwp-action-buttons">
            ...
            <a class="button add-template"><?php _e( 'Add New', 'fwp' ); ?></a>
            <div class="clear"></div>
        </div>
