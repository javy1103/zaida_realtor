...
if( $display_similar_properties == 'true' ){
        ...
        /* Main Post Property Price */
        $price_terms = get_post_meta( $post->ID,"REAL_HOMES_property_price", true );

        	$low_price = $price_terms - ($price_terms*0.10);
        	$high_price = $price_terms + ($price_terms*0.10);
        	$similar_properties_args = array(
	            ...
	            'meta_query'             => array(
						array(
							...
							'value'     => array($low_price,$high_price),
							'compare'   => 'BETWEEN',
							'type'      => 'NUMERIC',
						),
				),
